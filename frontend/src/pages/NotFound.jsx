...
export default function NotFound() {
  return (
    <div className="relative flex min-h-[60vh] flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="mt-3 text-3xl font-extrabold text-white">Página no encontrada</h1>
      <p className="mt-3 max-w-sm text-neutral-400">La página que buscas no existe o fue movida.</p>
